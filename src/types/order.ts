...
export type RefundMethod = {
  refundMethodAmount: number
  refundMethodName: string
}

export type RightsImageUrls = string[]

export type Rights = {
  bizRightsStatus: number
  bizRightsStatusName: string
  createTime: string
  orderNo: string
  refundAmount: number
  ...
  rightsMethod: number
  rightsNo: string
  rightsParentNo: string
  rightsReasonDesc: string
  rightsReasonType: number
  rightsStatus: number
  rightsStatusName: string
  rightsType: number
  saasId: number
  shippingFee: number
  shippingFeeBear: number
  storeId: number
  storeName: string
  uid: string
  updateTime: string
  userRightsStatus: number
  userRightsStatusDesc: string
  userRightsStatusName: string
  afterSaleRequireType?: string
  rightsImageUrls?: RightsImageUrls
}
...
export type AfterServiceListData = {
  pageNum: number
  pageSize: number
  totalCount: number
  states: States
  dataList: AfterServiceItem[]
}

export type AfterServiceListResponse = {
  data: AfterServiceListData
  code: string
  msg: string | null
  requestId: string
  clientIp: string
